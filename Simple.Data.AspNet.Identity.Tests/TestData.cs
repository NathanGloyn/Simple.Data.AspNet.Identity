...
namespace Simple.Data.AspNet.Identity.Tests
{
    public class TestData
    {
        ...
        {
            return new IdentityUser{Id = John_UserId, UserName = "John", Email = "John@test.com", SecurityStamp = "securityStamp", EmailConfirmed = true, PhoneNumberConfirmed = true, PhoneNumber = "123-456"};
        }
