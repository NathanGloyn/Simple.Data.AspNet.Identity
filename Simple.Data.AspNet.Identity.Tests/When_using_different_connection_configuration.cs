...
namespace Simple.Data.AspNet.Identity.Tests
{
    ...
    public class When_using_different_connection_configuration
    {
        ...
        [Test]
        public void Should_create_UserStore_with_connecton_string()
        {
            var target = new UserStore<IdentityUser>(@"Server=(localdb)\v11.0;Database=IdentityTest;Integrated Security=true;Trusted_Connection=True;");
            var task = target.FindByIdAsync(TestData.John_UserId);
            task.Wait();
        ...
        [Test]
        public void Should_create_RoleStore_with_connection_string()
        {
            var target = new RoleStore<IdentityRole>(@"Server=(localdb)\v11.0;Database=IdentityTest;Integrated Security=true;Trusted_Connection=True;");
